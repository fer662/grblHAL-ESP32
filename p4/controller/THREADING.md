...
brakes with X engaged. The feasibility check only requires enough span to reach
specified feed at the RPM ceiling; it does not shift the endpoint. The sequence
...
tests cover direction, starts, bounded endpoints, short-span feed feasibility,
