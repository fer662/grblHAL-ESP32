#!/usr/bin/env python3
"""Compile production batch submission plus the pinned native planner/step ISR; no hardware."""
...
with tempfile.TemporaryDirectory() as directory:
    ...
    sources=[p4/'tests/thread_native_test.c',p4/'main/thread_path.c',p4/'components/h5_ui/cycle_plan.c']
